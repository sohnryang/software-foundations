...
Theorem ev_8 : ev 8.
Proof.
  repeat apply ev_SS. apply ev_0. Show Proof.
Qed.
...
Definition conj_fact : forall P Q R, P /\ Q -> Q /\ R -> P /\ R :=
  fun (P : Prop) => fun (Q : Prop) => fun (R : Prop) =>
    fun (HPQ : and P Q) => fun (HQR : and Q R) => match HPQ with
...
Proof.
  intros H. unfold proof_irrelevance. intros P HP.
  assert (EQ: True = P). { apply pe_implies_true_eq. apply H. apply HP. }
  generalize dependent HP. rewrite <- EQ. intros pf1 pf2. destruct pf1.
